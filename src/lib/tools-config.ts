...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    category: "document",
    href: "/convert",
    keywords: ["pptx", "powerpoint", "presentation", "pdf"],
  },
  {
    id: "xlsx-to-pdf",
    name: "Excel to PDF",
    description: "Convert spreadsheets to PDF files.",
    category: "document",
    href: "/convert",
    keywords: ["xlsx", "excel", "spreadsheet", "pdf"],
  },
  {
    id: "html-to-pdf",
    name: "HTML to PDF",
  ...
  },
  {
    ...
    category: "pdf",
    href: "/convert?tab=pdf",
    keywords: ["pdf", "unlock", "decrypt", "password"],
  },
  {
    id: "pdf-protect",
    name: "Protect PDF",
    ...
    category: "pdf",
    href: "/convert?tab=pdf",
    keywords: ["pdf", "protect", "encrypt", "password"],
  },
  {
    id: "image-resize",
